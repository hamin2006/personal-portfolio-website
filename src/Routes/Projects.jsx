...
const projectsData = [
  {
    ...
    title: "OER-AI",
    description:
      "Built on AWS Cloud Infrastructure, this web application uses GenAI to support intelligent interaction with OER textbooks. Leveraging RAG, multimodal embeddings, and conversational AI, the platform provides personalized learning assistance informed by UDL Principles. The AI-powered Study Companion provides real-time responses with citations and voice customization. Instructors can create Multiple Choice Questions, Short Answers with AI-assisted grading, and Flashcards, exportable as H5P packages for LMS platforms. This open-source solution is adaptable for K-12, vocational training, and OER initiatives.",
    tags: [
      "React.js",
      "RAG",
      "ETL Pipelines",
  ...
  },
  {
    ...
    description:
      "Built on AWS Cloud Infrastructure, this prototype utilizes Large Language Models to support research analysis across diverse data sources. Researchers upload survey responses, audio transcripts, and documents for text conversion and evaluation. The system employs LLM prompting and Retrieval Augmented Generation (RAG), drawing on contextual documents to strengthen interpretability. A spatial empathy use case demonstrates analyzing emotional connections to places. Built using Amazon Bedrock, the solution provides security, scalability, and ensures user data is never used for model training.",
    tags: [
      "Amazon EC2",
      "AI Agents",
      "Amazon RDS",
  ...
  },
  {
    ...
    title: "Jarviz",
    description:
      "Jarviz is an AI-powered personal assistant inspired by J.A.R.V.I.S. from Iron Man, featuring voice command integration with an immersive futuristic interface. Built with Python asyncio, the backend leverages LangChain + LangGraph for agent orchestration, GPT for reasoning, Qwen VL 32B for vision, and OpenAI Whisper for speech-to-text. ElevenLabs provides WebSocket streaming TTS, while OpenWakeWord enables offline wake word detection. The PyQt5 frontend uses OpenCV and custom QPainter animations to create holographic-style HUD overlays, delivering contextual awareness and multimodal interaction capabilities.",
    tags: [
      "Python",
      "PyQt5",
      "LangChain",
